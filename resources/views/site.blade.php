	...
	<header class="header-site mb-5 p-5 bg-success shadow-sm">
		<div class="row">
			<div class="col-lg-8 text-white">
				...
				<p class="lead py-3">Quantas vezes n&oacute;s Dev's ficamos desesperados atr&aacute;s de uma
					solu&ccedil;&atilde;o para uma d&uacute;vida?</p>
				<div class="row">
					<div class="col-lg-3">
						<b-button @click="$bvModal.show('modal-create-question')" variant="link"
							class="btn btn-light btn-block my-1 shadow">Pedir Ajuda</b-button>
					</div>
					<div class="col-lg-4">
						<a class="btn btn-primary btn-block my-1 shadow" href="{{ route('questions.index') }}">Ajude
							Alguém!</a>
					</div>
				</div>
			</div>
		...
		<article>
			<div class="row">
				<div class="col-lg-6 py-4">No stackoverflow n&atilde;o encontramos algo espec&iacute;fico e para fazer a
					nossa pr&oacute;pria pergunta &eacute; meio que "burocratico" e demora muito para se ter uma
					resposta.
				</div>
			</div>
			<div class="row flex-row-reverse">
				<div class="col-lg-6 py-4">Nos grupos de programa&ccedil;&atilde;o do Facebook os Dev's tem suas tarefas
					do
			...
			<div class="row flex-row-reverse">
				<div class="col-lg-6 py-4">Funciona assim: ao ter uma d&uacute;vida que voc&ecirc; n&atilde;o encontra
					solu&ccedil;&atilde;o em lugar nenhum, corra para o AskDev e publique sua pergunta, juntamente com
					um
			...
			<div class="row">
				<div class="col-lg-6 py-4">Programadores ver&atilde;o sua pergunta e aqueles que se julgarem aptos a lhe
					a
					ajudar, o far&atilde;o uma proposta com base no valor que voc&ecirc; estipulou.</div>
			</div>
			<div class="row flex-row-reverse">
				<div class="col-lg-6 py-4">Ent&atilde;o voc&ecirc; analisa as propostas, escolhe uma, efetua o pagamento
					via
					boleto ou cart&atilde;o de cr&eacute;dito(tudo feito pelo MercadoPago), e voc&ecirc;s j&aacute;
					podem
					come&ccedil;ar a trabalhar para solucionar a d&uacute;vida. Ter&aacute; espa&ccedil;o subir seu
					trecho
					de c&oacute;digo, o projeto todo, integra&ccedil;&atilde;o com GitHub, Plunker e etc&hellip;</div>
			</div>
			<div class="row">
				<div class="col-lg-6 py-4">O dinheiro s&oacute; ser&aacute; liberado a quem est&aacute; ajudando, quando
					o
			...
			<div class="row">
				<div class="col-lg-6 py-4">E o mais legal &eacute; que voc&ecirc; pode ser um ajudante ou um ajudado,
					ajude
					outros programadores em apuros e fique com saldo positivo em sua conta, use esse saldo para
					solucionar
