...
@section('title', 'Fazer uma Recarga - ')
	...
	<div class="row justify-content-center">
		<div class="col-lg-10">
			<form action="{{ route('payments.paypal.fund') }}" method="POST">
						...
						<div class="row">
							<div class="col">
								...
								<div class="input-group input-group-lg">
									...
									<input type="text" class="form-control" id="budget" name="budget" autofocus
										required />
								</div>
							</div>
						</div>
				...
				<h2 class="text-muted font-weight-light h4 mt-5">Selecione o método de pagamento que deseja utilizar
				</h2>
				<div class="card">
					<div class="card-body">
